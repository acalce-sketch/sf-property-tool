...
with col2:
    ...
    with st.expander(f"Zoning mix in {neighborhood} ({len(df)} parcels)"):
        ...
        if zoning_fig is not None:
            ...
            st.caption("Static snapshot, not interactive \u2014 each cell shows whichever zoning group has the most parcels in that area of the loaded sample.")
        else:
